...
MasterApplication::MasterApplication(std::string const & fileNameA, std::string const & fileNameB)
{
    FileNameA = fileNameA;
    FileNameB = fileNameB;
...
void MasterApplication::ReadInFiles()
{
    Profiler.Start("Map");
...
void MasterApplication::SendVectorsToSlaves()
{
    Profiler.Start("Send");
...
void MasterApplication::CalculateSum()
{
    Profiler.Start("Sum");
    C.MakeSum(A, B);
...
void MasterApplication::MakeHistograms()
{
    Profiler.Start("Hist");
...
void MasterApplication::WriteOutputFiles()
{
